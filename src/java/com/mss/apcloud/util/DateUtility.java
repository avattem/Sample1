...
public class DateUtility {
 ...
 public String convertToviewFormatDateTime(String dateString){
...
public Timestamp convertStringMysqlTimeStamp(String dateString) throws ParseException{
	 ...
	 public String convertTimeStampToviewFormat(String dateString) {
        SimpleDateFormat sdfInput = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        SimpleDateFormat sdfOutput = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss");
        java.util.Date date = null;
        try {
