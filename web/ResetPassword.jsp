<%-- 
    ...
    Created on : Jul 18, 2016, 11:37:03 PM
    Author     : miracle
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <title> 
            AP Cloud Initiative | Reset Password
        </title>
...
<!--            <style>
 ...
 <section class="site-section site-section-top site-section-light themed-background-dark-default backgroundImage">
                    ...
                    <div class="push text-center">
                       <h1 class="animation-fadeInQuick2Inv"><strong>Reset Password</strong></h1>
                        </div>
                 ...
                 <div class="col-sm-10">
                    ...
                    <div class="tab-content">
                        <div class="row  tab-pane active" id="ResetPassword">
                           ...
                           <s:form action="resetPasswordSubmit.action" name="resetForm" theme="simple" onsubmit="return resetEmpPwdSubmit();">
                               <%
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                  ...
                                  <%--  <s:textfield cssClass="form-control" placeholder="Email*" name="emailid" id="emailid" required="required"  onchange="checkEmail(this);borderCssChange(this);" /> --%>
                                      ...
                                      <s:password cssClass="form-control" id="oldPassword" name="oldPassword" placeholder="Password*" required="required" onchange="fieldLengthValidator(this);borderCssChange(this);"  />
                                </div>
