    ...
    <![endif]-->
        ...
        <script>
            $(document).ready(function () {
                ...
                var table=$('#workshoplist').DataTable({
                    "searching": true,
                    "info": false,
                    "autoWidth": true,
                    "ordering": false,
                            ...
                            <div class="row">
                                <div class="col-sm-2" >
                                    <div class="form-group">
                                        ...
                                        <a href="<s:url value="/general/topicDetails.action"/>" class="btn btn-primary" >Add Topic</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table t_st03" id="workshoplist">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <i class="fa  fa-barcode" aria-hidden="true"></i>  ID
                                            </th>
                                            <th>
                                                <i class="fa  fa-barcode" aria-hidden="true"></i>  Topic Name
                                            </th>


                                            <!--                                            <th>
                                                                                            <i class="fa fa-university" aria-hidden="true"></i> MCert Id
                                                                                        </th>-->
                                            <th>
                                                <i class="fa fa-calendar" aria-hidden="true"></i> Status
                                            </th>
                                            <th>
                                                <i class="fa fa-users" aria-hidden="true"></i>  Web Page Data
                                            </th> 

                                            <th>
                                                <i class="fa fa-location-arrow" aria-hidden="true"></i>  Documents Add
                                            </th>
                                    ...
                                    <tbody>
                                        ...
                                        <s:iterator value="topicList">
                                            <tr> 
                                                ...
                                                <%-- <td align="left"><s:property value="examId"/></td>--%>
                                                <td align="left"><s:property value="status"/></td>
                                                <td><a href="<s:url value="/general/topicDetails.action"/>?topicId=<s:property value="id"/>" class="btn btn-primary btn-circle" >Edit</a></td>


                                                <td align="left"><a href="<s:url value="/general/documentsList.action"/>?topicId=<s:property value="id"/>&topicName=<s:property value="topicName"/>" class="btn btn-primary btn-circle" >Go</a></td>
                            ...
                            <div class="row" id="collegeRegDetails">
                                ...
                                <div class="col-sm-12">
                                    <div id="techTopics">
                                        ...
                                        <s:form theme="simple" action="topicsAdd.action" method="post" enctype="multipart/form-data" >
                                            <div class="row">
                                                ...
                                                <div class="cal-sm-3">
                                                    ...
                                                    <div id="topicText" >
                                                        <s:textfield name="topicName" cssClass="form-control" id="topicName"   value="" onchange="startingCapital(this);"/>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="cal-sm-3">
                                                    ...
                                                    <input type="file" name="image" cssClass="form-control" id="image"  value="" onchange="return imageName();"/>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="cal-sm-3">
                                                    ...
                                                    <s:select cssClass="form-control"  headerKey="-1" headerValue="---Please Select type---" id="status" name="status" list="#@java.util.LinkedHashMap@{'Active':'Active','InActive':'InActive'}" />
                                            ...
                                            <div class="row">
                                                <div id="saveOverlayEnable" style="display: block;">
                                                    <s:submit class="btn btn-primary col-sm-12" data-loading-text="<i class='fa fa-spinner fa-spin '></i> loading..." id="save" name="save" tabindex="12" type="save" value="save" onclick="addWorkshopDetails();"/> 
                                                </div>
