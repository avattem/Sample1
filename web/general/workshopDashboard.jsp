    ...
    <body>
        ...
        <section class="site-section site-section-top site-section-light themed-background-dark-default backgroundImage">
                    ...
                    <div class="push text-center">
                       <h1 class="animation-fadeInQuick2Inv"><strong>List of available Workshops</strong></h1>
                        </div>
...
<!--                            <table style="margin:0 0 29px"> <tr><th class="p_tit"><i class="fa fa-minus" aria-hidden="true"></i> List of available Workshops  </th></tr></table>-->
                            <table id="workshoplist" class="table t_st03">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <i class="fa fa-file-code-o"></i>Topics
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    <s:iterator value="workshopList">
                                        <tr> 
                                            ...
                                            <td><a href="#" data-toggle="modal" data-target="#myModal" onclick="getCurriculam('<s:property value="Code"/>','<s:property value='%{CollegeName.replaceAll("\'", "&quot")}'/>','<s:property value="location"/>');">Curriculam</a></td>
                                            <td align="left"><a class="btn btn-primary" href="<%=request.getContextPath()%>/general/workshoptopics.action?workshopCode=<s:property value="Code"/>">Enroll Topics</a></td>
                                            <%-- <td align="left">
