...
var App = function() {
    ...
    var page, pageContent, header, sidebar, sBrand, sExtraInfo, sidebarAlt,sidebarSpark, sScroll, sScrollAlt;
    ...
    var handleSidebar = function(mode){
        if (mode === 'init') {
            ...
            else if (mode === 'toggle-sidebar-spark') {
                if ( windowW > 991) { // Toggle alternative sidebar in large screens (> 991px)
                    page.toggleClass('sidebar-alt-visible-lg');
                } else { // Toggle alternative sidebar in small screens (< 992px)
                    page.toggleClass('sidebar-alt-visible-xs');
            ...
            else if (mode === 'open-sidebar-spark') {
                if ( windowW > 991) { // Open alternative sidebar in large screens (> 991px)
                    page.addClass('sidebar-spark-visible-lg');
                } else { // Open alternative sidebar in small screens (< 992px)
                    page.addClass('sidebar-spark-visible-xs');
                    handleSidebar('close-sidebar');
                }
            }
            else if (mode === 'close-sidebar-spark') {
                if ( windowW > 991) { // Close alternative sidebar in large screens (> 991px)
                    page.removeClass('sidebar-spark-visible-lg');
                } else { // Close alternative sidebar in small screens (< 992px)
                    page.removeClass('sidebar-spark-visible-xs');
                }
            }
